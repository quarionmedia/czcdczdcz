...
$route['android/getYoutubeStream'] = 'RestApi/Android/Android_api/getYoutubeStream';

//Google Drive Stream
$route['android/gdstream/(:any)/(:any)'] = 'RestApi/Android/Gdstream/stream/$1/$2';

$route['android/getVidhideStreamLink'] = 'RestApi/Android/Android_api/getVidhideStreamLink';
$route['android/getVidhideDownloadLink'] = 'RestApi/Android/Android_api/getVidhideDownloadLink';

$route['android/getStripePaymentIntent'] = 'RestApi/Android/Android_api/getStripePaymentIntent';
$route['android/getCoingatePaymentIntent'] = 'RestApi/Android/Android_api/getCoingatePaymentIntent';
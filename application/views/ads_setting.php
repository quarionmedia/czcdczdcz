                        	...
                        	<div class="col-md-12">
                        		<div class="card card-body">
                        			<form method="post">
                                        ...
                                        <br>
                                        <br>
                                        <strong>Wortise Ads</strong>
                                        <hr>
                                        <div class="form-group row mb-3">
                                            <label class="col-sm-3 control-label">Wortise App Key</label>
                                            <div class="col-sm-3">
                                                <input type="text" value="<?php echo $config->wortise_app_key; ?>"
                                                       id="wortise_app_key" name="wortise_app_key" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-sm-3 control-label">Wortise Banner Ad ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" value="<?php echo $config->wortise_banner_ad_id; ?>"
                                                       id="wortise_banner_ad_id" name="wortise_banner_ad_id" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-sm-3 control-label">Wortise Interstitial Ad ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" value="<?php echo $config->wortise_interstitial_ad_id; ?>"
                                                       id="wortise_interstitial_ad_id" name="wortise_interstitial_ad_id" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-sm-3 control-label">Wortise Native Ad ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" value="<?php echo $config->wortise_native_ad_id; ?>"
                                                       id="wortise_native_ad_id" name="wortise_native_ad_id" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-sm-3 control-label">Wortise AppOpen Ad ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" value="<?php echo $config->wortise_appopen_ad_id; ?>"
                                                       id="wortise_appopen_ad_id" name="wortise_appopen_ad_id" class="form-control">
                                            </div>
                                        </div>
    ...
    <script>
        $( document ).ready(function() {
            ...
            if (ad_type == "0") {
                ...
                $("#mobile_ads_network_Controll").val("9");
            }else {
                $("#mobile_ads_network_Controll").val("0");
            }
